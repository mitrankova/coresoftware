...
std::cout<<"iregion = "<<iregion<<" zside = "<<zside<<" phibin width "<< PhiBinWidth[iregion]<<" sector min Phi = "<<sec_min_phi<<" sec_max_phi = "<<sec_max_phi<<" sec_phi = "<<sec_max_phi - sec_min_phi<<"sector gap = "<<sec_gap<<std::endl;
